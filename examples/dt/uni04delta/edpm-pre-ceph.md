...
# 2. Change the working directory to uni04delta/edpm-pre-ceph/nodeset

    $ pushd architecture/examples/dt/uni04delta/edpm-pre-ceph/nodeset
...
# 7. Change the working directory to uni04delta/edpm-pre-ceph

    $ pushd architecture/examples/dt/uni04delta/edpm-pre-ceph
