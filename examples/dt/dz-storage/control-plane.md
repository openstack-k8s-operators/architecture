...
The Cinder volume secrets and Manila share secrets should be updated
in the `service-values.yaml` file to include the information for
Cinder and Manila to connect to the storage arrays. Look for
