...
Edit the [control-plane2/networking/nncp/values.yaml](control-plane2/networking/nncp/values.yaml),
[control-plane2/service-values.yaml](control-plane2/service-values.yaml), and
[control-plane2/skmo-values.yaml](control-plane2/skmo-values.yaml) files to suit
your environment.
```
...
Generate the control-plane and networking CRs (control-plane2 is an SKMO leaf
region that uses the central Keystone endpoints).
```
